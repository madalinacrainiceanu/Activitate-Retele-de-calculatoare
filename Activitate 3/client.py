...
class FTPClient:
    ...
    def rename_file(self):
        ...
        # luam fisierele curente pentru a alege
        self.list_files()
    ...
    def read_file(self):
        ...
        self.list_files()
        filename = input("Numele fisierului de citit: ").strip()
    ...
    def download(self):
        ...
        self.list_files()
        filename = input("Numele fisierului de descarcat: ").strip()
        if not filename: return
        ...
        if response['status'] == 'error':
            ...
            try:
                ...
                print(f"✓ Fisierul {filename} a fost salvat in {LOCAL_FILES_DIR}/")
            except Exception as e:
                print(f"✗ Eroare la scrierea locala: {str(e)}")
    ...
    def edit_file(self):
        ...
        self.list_files()
        filename = input("Numele fisierului de editat: ").strip()
        if not filename: return
        
        new_content = input("Noul continut: ").strip()
    ...
    def see_file_operation_history(self):
        ...
        self.list_files()
        filename = input("Numele fisierului pentru a vedea istoricul: ").strip()
        if not filename: return
